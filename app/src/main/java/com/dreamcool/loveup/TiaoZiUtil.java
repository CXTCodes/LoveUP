...
public class TiaoZiUtil {
    ...
    private static String context3;
    ...
    public TiaoZiUtil(long time, Context context) {
        this.time = time;//间隔时间
                        ...
                        try {
                            ...
                            if (nn <= length1) {//如果还有汉字，那么继续开启线程，相当于递归的感觉
                                ...
                                if((textView1.getText()+"").length()==context1.length()){
                                    TiaoZiUtil2 tiaoZiUtil2 = new TiaoZiUtil2(200,context);
                                    tiaoZiUtil2.setContext1(context2);
                                    tiaoZiUtil2.setTextView1(textView2);
                                    tiaoZiUtil2.setContext2(context3);
                                    tiaoZiUtil2.setTextView2(textView3);
                                    tiaoZiUtil2.start();
                                }
                            }
